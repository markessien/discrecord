...
Begin VB.Form FrmBurn 
   ...
   Begin VB.Label Label10 
      BackStyle       =   0  'Transparent
      Caption         =   "Essien Research && Development"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   6.75
         Charset         =   0
   ...
   Begin VB.Label Label6 
      BackStyle       =   0  'Transparent
      Caption         =   "Complex CD Burner. For the Advanced User."
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.Menu mnuFile 
      ...
      Begin VB.Menu mnuSaveISO 
         Caption         =   "Save Image as ISO File"
      End
...
Private Sub Form_Load()
    ...
    CmbType.ComboItems.item(2).Selected = True
