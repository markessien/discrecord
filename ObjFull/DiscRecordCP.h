#ifndef _DISCRECORDCP_H_
#define _DISCRECORDCP_H_
...
template <class T>
class CProxy_IDiscRecordObjEvents : public IConnectionPointImpl<T, &DIID__IDiscRecordObjEvents, CComDynamicUnkArray>
{
	//Warning this class may be recreated by the wizard.
public:
	HRESULT Fire_DeviceListed(BSTR Name, BSTR Adapter, VARIANT_BOOL CanWrite)
	{
